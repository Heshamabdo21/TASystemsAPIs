...
public class Policies_API {
   ...
   // String All_Policies_Path = "/policies";
    String All_Policies_Path = testDataReader.getCellData("API_Data","GetAllPolicies","Data1");
    ...
    public void Check_policies_Response_Valid_Schema() {
        All_Policies_api.assertThatResponse().matchesSchema(testDataReader.getCellData("API_Data","GetAllPolicies","Data2")).perform();
