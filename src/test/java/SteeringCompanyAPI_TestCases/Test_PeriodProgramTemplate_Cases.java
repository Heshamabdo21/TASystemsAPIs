...
public class Test_PeriodProgramTemplate_Cases {
    ...
    public void Valid_GET_all_PeriodProgramTemplate_Rq_TC() {
    ...
    public Object[][] Valid_Get_PeriodProgramTemplate_Pagination(){
    ...
    @Severity(SeverityLevel.CRITICAL)
    public void Valid_GET_all_PeriodProgramTemplate_by_Qry_Rq_TC(Object[] data) {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
        String Token =Token_TC.Get_Valid_Access_Token();
    ...
    public void Invalid_GET_all_PeriodProgramTemplate_with_missing_Token_TC() {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
    ...
    @Severity(SeverityLevel.MINOR)
    public void Invalid_GET_PeriodProgramTemplate_ByID_with_missing_Token_TC() {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
    ...
    @Severity(SeverityLevel.MINOR)
    public void Invalid_GET_all_PeriodProgramTemplate_with_invalid_Token_TC() {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
        PeriodProgramTemplates_API GetAllPeriodProgramTemplate_TC=new PeriodProgramTemplates_API();
    ...
    @Story("Retrieving All Active PeriodProgramTemplate with invalid/expired Token")
    @Severity(SeverityLevel.MINOR)
    public void Invalid_GET_PeriodProgramTemplate_ByID_with_invalid_Token_TC() {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
        PeriodProgramTemplates_API GetAllPeriodProgramTemplate_TC=new PeriodProgramTemplates_API();
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    @Severity(SeverityLevel.CRITICAL)
    public void Valid_Get_PeriodProgramTemplate_ByID_Rq_TC(Object[] data) {
        Token_API Token_TC=new Token_API();
        Token_TC.POST_Valid_TOKEN_Rq(UserName,Password);
        Token_TC.Check_Token_Valid_status_Code_Response();
        String Token =Token_TC.Get_Valid_Access_Token();
